...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Cgxcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"cgxcointools.com", "dnsseed.cgxcointools.com"},
    {"cgxcoinpool.org", "dnsseed.cgxcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"cgxcointools.com", "testnet-seed.cgxcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Cgxcoin is probably already running."), addrBind.ToString().c_str());
        else
